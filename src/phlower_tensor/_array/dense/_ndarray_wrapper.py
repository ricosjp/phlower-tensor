...
from phlower_tensor.utils.typing import DenseArrayType


class NdArrayWrapper(IPhlowerArray[DenseArrayType]):
    def __init__(
        self,
        data: np.ndarray,
    ...
    def slice_along_time_axis(self, time_slice: slice) -> NdArrayWrapper:
